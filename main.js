/* =========================================================
   main.js — منطق الموقع: المقالات + الدخول + الحركات
========================================================= */
(function(){
'use strict';
...
const DEFAULT_ARTICLES = [
  {id:1, title:'دليلك الشامل للإقرار الضريبي السنوي 2026', category:'ضرائب', status:'published',
  ...
  {id:3, title:'أفضل شكل قانوني لشركتك الناشئة في 2026', category:'تأسيس شركات', status:'published',
   date:'2026-01-02', image:'',
  ...
  {id:4, title:'كيف تعد دراسة جدوى مشروع ناجحة؟', category:'دراسات جدوى', status:'published',
   date:'2025-12-28', image:'',
  ...
  {id:5, title:'خصومات ضريبية قد لا تعرفها لشركتك', category:'ضرائب', status:'published',
   date:'2025-12-20', image:'',
  ...
  {id:6, title:'دليل المبتدئين في الاستيراد والتصدير 2026', category:'استيراد وتصدير', status:'published',
...
function articleCard(a){
  ...
  const thumb = a.image
    ...
    : `<div class="ph"><i class="fa-solid ${icon}"></i></div>`;
...
/* عرض كل المقالات + الفلترة في صفحة المقالات */
...
if(fullGrid){
  ...
  /* فتح مقال عبر الرابط index.html#5 */
