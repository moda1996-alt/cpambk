...
const DEFAULT_ARTICLES = [
  {id:1,title:'دليلك الشامل للإقرار الضريبي السنوي 2026',category:'ضرائب',status:'published',date:'2026-01-15',image:'',excerpt:'كل ما تحتاج معرفته عن مواعيد تقديم الإقرار الضريبي.',content:'يُعد الإقرار الضريبي السنوي من أهم الالتزامات القانونية.'},
  {id:2,title:'خطوات التسجيل في منظومة الفاتورة الإلكترونية',category:'الفاتورة الإلكترونية',status:'published',date:'2026-01-08',image:'',excerpt:'دليل عملي شامل للتسجيل في منظومة الفاتورة.',content:'أصبحت منظومة الفاتورة الإلكترونية إلزامية لشرائح واسعة من الممولين.'},
  {id:3,title:'أفضل شكل قانوني لشركتك الناشئة في 2026',category:'تأسيس شركات',status:'published',date:'2026-01-02',image:'',excerpt:'مقارنة شاملة بين أنواع الشركات.',content:'اختيار الشكل القانوني المناسب هو أول قرار استراتيجي.'},
  {id:4,title:'كيف تعد دراسة جدوى مشروع ناجحة؟',category:'دراسات جدوى',status:'published',date:'2025-12-28',image:'',excerpt:'الخطوات الأساسية لإعداد دراسة جدوى.',content:'دراسة الجدوى هي البوصلة التي تحدد مصير مشروعك.'},
  {id:5,title:'خصومات ضريبية قد لا تعرفها لشركتك',category:'ضرائب',status:'published',date:'2025-12-20',image:'',excerpt:'قائمة بأهم المصروفات والخصومات.',content:'كثير من أصحاب الأعمال يفقدون مبالغ كبيرة.'},
  {id:6,title:'دليل المبتدئين في الاستيراد والتصدير 2026',category:'استيراد وتصدير',status:'published',date:'2025-12-15',image:'',excerpt:'كل ما تحتاج معرفته لبدء نشاط الاستيراد.',content:'الدخول إلى عالم الاستيراد يتطلب فهم الإجراءات.'}
];
...
function showApp(){ loginScreen.style.display = 'none'; appScreen.classList.add('show'); refreshAll(); }
function showLogin(){ appScreen.classList.remove('show'); loginScreen.style.display = 'flex'; }
...
function fmtDate(iso){ try{ return new Date(iso).toLocaleDateString('ar-EG',{year:'numeric',month:'long',day:'numeric'}); }catch(e){ return iso; } }
